  ...
  return (
    <section className="w-11/12 flex flex-col justify-center mb-20 m-auto">
      ...
      <div className="flex justify-between w-8/12 mb-10 m-auto">
        <button className="w-28 bg-gray-100 text-black pt-1 pb-1 pl-4 pr-4 rounded-3xl hover:bg-gray-300 transition-all ease-linear duration-100">Sign Up</button>
        <button className="w-28 bg-gray-100 text-black pt-1 pb-1 pl-4 pr-4 rounded-3xl hover:bg-gray-300 transition-all ease-linear duration-100">Log In</button>
      </div>
